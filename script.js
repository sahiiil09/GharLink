...
let tasks =
    loadData("Your'z HubTasks");

let bills =
    loadData("Your'z HubBills");

let family =
    loadData("Your'z HubFamily");

let notes =
    loadData("Your'z HubNotes");

let links =
    loadData("Your'z HubLinks");
...
function openAbout() {
    ...
    $("detailContent")
        ...
        <div class="about-card">
            ...
            <p>
                Your'z Hub is a simple family utility
